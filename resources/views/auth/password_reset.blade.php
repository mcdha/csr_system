                ...
                <div class="card-wrapper" style="width: 400px">
                    ...
                    <div class="card fat">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('password_reset.save_new_password') }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('new_password') is-invalid @enderror"
                                        id="new-password-input" placeholder="Enter new password" name="new_password">
                                    @error('new_password')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('confirm_password') is-invalid @enderror" id="confirm-password-input"
                                ...
                                @if (Session::get('error') || Session::get('success'))
                                    <div class="alert alert-{{ Session::get('error') ? 'danger' : 'success' }} alert-dismissible fade show small"
                                        role="alert">
